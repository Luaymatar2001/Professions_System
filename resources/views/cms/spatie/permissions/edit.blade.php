...
<section class="content">
    ...
    <script>
        // const roleStoreRoute = 'http://127.0.0.1:8000/api/permission/update/{id}';
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{$permissions->name}}" placeholder="Enter name" required>
                                {{-- @error('name') --}}
                                <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" id='guards' name="guards" required>
                        ...
                        <option value="web" @if($permissions->guard_name == 'web') selected @endif>Web</option>
            ...
            <div class="card-footer">
                <button type="button" onclick="sendData({{$permissions->id}})" class="btn btn-primary">Edit</button>
            </div>
            </form>
        </div>
        <!-- /.card -->
...
fetch('https://phplaravel-1025967-3619615.cloudwaysapps.com/admin/permission/'+id,
{   
    method: 'PUT',
    headers: {  
 ...
 text: "Edit the permission has been completed successfully!"+"\n  {  name : "+document.getElementById("name").value+",  guards : "+
