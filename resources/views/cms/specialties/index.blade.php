                        ...
                        <table class="table table-hover table-bordered table-striped text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr id='ID{{ $specialties->id }}'>
                                    ...
                                    <td>{{ $specialties->updated_at }}</td>
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{route('specialities.edit',$specialties->id)}}"
                                                class="btn btn-info">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form method="POST"
                                                action="{{route('specialities.destroy',$specialties->id)}}" ,
                                                id="sub_Delete{{$specialties->id}}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger delete{{$specialties->id}}">
                                                    <i class="fas fa-trash-alt"></i>
                                                </button>
                                                <script>
                                                    $('.delete{{$specialties->id}}').click(function(e){
                                                          e.preventDefault()
                                                               ...
                                                               dangerMode: true,
                                                                    buttons: {
                                                                     ...
                                                                     if(e == "ok"){
                                                                      $('#sub_Delete{{$specialties->id}}').submit();
                                                                   }
                                                               });
                                                        });
                                                </script>
